...
>
  <head>
    ...
    <title>Error - Pages | Wan Course</title>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="../../../assets/dashboard/vendor/css/pages/page-misc.css" />
    <!-- Helpers -->
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <a href="#" class="btn btn-primary" onclick="history.back(); return false;">Go back</a>
        <div class="mt-3">
          <img
            src="../../../assets/dashboard/img/illustrations/page-misc-error-light.png"
